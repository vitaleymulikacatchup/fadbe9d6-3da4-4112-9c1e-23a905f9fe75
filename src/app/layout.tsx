...
export const metadata: Metadata = {
  title: "Azure Bay Hotel - Luxury Resort & Premium Hospitality",
  description: "Experience luxury at Azure Bay Hotel with world-class amenities, stunning ocean views, fine dining, spa services, and exceptional hospitality for unforgettable stays.",
  keywords: "luxury hotel, resort, ocean view, spa, fine dining, premium hospitality, vacation, Azure Bay Hotel",
  openGraph: {
    title: "Azure Bay Hotel - Luxury Resort & Premium Hospitality",
    description: "Experience luxury at Azure Bay Hotel with world-class amenities, stunning ocean views, fine dining, spa services, and exceptional hospitality for unforgettable stays.",
    siteName: "Azure Bay Hotel",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/2422393/pexels-photo-2422393.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Luxury hotel exterior with palm trees and ocean view"
      }
    ]
  },
  twitter: {
    ...
    title: "Azure Bay Hotel - Luxury Resort & Premium Hospitality",
    description: "Experience luxury at Azure Bay Hotel with world-class amenities, stunning ocean views, fine dining, spa services, and exceptional hospitality.",
    images: ["https://images.pexels.com/photos/2422393/pexels-photo-2422393.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
